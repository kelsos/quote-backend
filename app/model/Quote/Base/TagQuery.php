...
abstract class TagQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Quote\Base\TagQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Quote\\Tag', $modelAlias = null)
    {
    ...
    public function filterByQuoteTag($quoteTag, $comparison = null)
    {
        if ($quoteTag instanceof \Quote\QuoteTag) {
            return $this
                ->addUsingAlias(TagTableMap::COL_ID, $quoteTag->getTagId(), $comparison);
     ...
     *
     * @param Quote $quote the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildTagQuery The current query, for fluid interface
     */
    public function filterByQuote($quote, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useQuoteTagQuery()
            ->filterByQuote($quote, $comparison)
            ->endUse();
    }
