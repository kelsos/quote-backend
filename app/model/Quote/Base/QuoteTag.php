...
/**
 * Base class that represents a row from the 'quote_tag' table.
 *
 *
 *
* @package    propel.generator.Quote.Base
*/
abstract class QuoteTag implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Quote\\Map\\QuoteTagTableMap';
    ...
    /**
     * Initializes internal state of Quote\Base\QuoteTag object.
     */
    ...
    /**
     * Compares this with another <code>QuoteTag</code> instance.  If
     * <code>obj</code> is an instance of <code>QuoteTag</code>, delegates to
     * <code>equals(QuoteTag)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|QuoteTag The current object, for fluid interface
     */
     ...
     * @return $this|\Quote\QuoteTag The current object (for fluent API support)
     */
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[QuoteTagTableMap::COL_TAG_ID] = true;
        }
    ...
    public function setQuoteId($v)
    {
        ...
        if ($this->quote_id !== $v) {
            $this->quote_id = $v;
            $this->modifiedColumns[QuoteTagTableMap::COL_QUOTE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : QuoteTagTableMap::translateFieldName('TagId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : QuoteTagTableMap::translateFieldName('QuoteId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = QuoteTagTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Quote\\QuoteTag'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aQuote !== null && $this->quote_id !== $this->aQuote->getId()) {
            $this->aQuote = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildQuoteTagQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see QuoteTag::setDeleted()
     * @see QuoteTag::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildQuoteTagQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                QuoteTagTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(QuoteTagTableMap::COL_TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'tag_id';
        }
        if ($this->isColumnModified(QuoteTagTableMap::COL_QUOTE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'quote_id';
        }

        $sql = sprintf(
            'INSERT INTO quote_tag (%s) VALUES (%s)',
    ...
    {
        $pos = QuoteTagTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['QuoteTag'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['QuoteTag'][$this->hashCode()] = true;
        $keys = QuoteTagTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getTagId(),
            $keys[1] => $this->getQuoteId(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Quote\QuoteTag The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuoteTagTableMap::COL_TAG_ID)) {
            $criteria->add(QuoteTagTableMap::COL_TAG_ID, $this->tag_id);
        }
        if ($this->isColumnModified(QuoteTagTableMap::COL_QUOTE_ID)) {
            $criteria->add(QuoteTagTableMap::COL_QUOTE_ID, $this->quote_id);
        }
    ...
    {
        $criteria = ChildQuoteTagQuery::create();
        $criteria->add(QuoteTagTableMap::COL_TAG_ID, $this->tag_id);
        $criteria->add(QuoteTagTableMap::COL_QUOTE_ID, $this->quote_id);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getTagId() &&
            null !== $this->getQuoteId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation quote_tag_fk_022a95 to table tag
        ...
        //relation quote_tag_fk_8470aa to table quote
    ...
    {
        return (null === $this->getTagId()) && (null === $this->getQuoteId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Quote\QuoteTag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Quote\QuoteTag Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aTag) {
            $this->aTag->removeQuoteTag($this);
        }
        if (null !== $this->aQuote) {
            $this->aQuote->removeQuoteTag($this);
        }
        $this->tag_id = null;
        $this->quote_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(QuoteTagTableMap::DEFAULT_STRING_FORMAT);
    }
